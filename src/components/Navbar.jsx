...
<nav class="bg-blue-200 dark:bg-gray-900 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
  ...
  <a class="flex items-center">
      {/* <img src='' class="h-8 mr-3" alt="Inovate Logo"/> */}
      <span class="self-center text-3xl font-bold whitespace-nowrap dark:text-white">INOVATE</span>
  </a>
  <div class="flex md:order-2">
  {user?.displayName ? (
        <button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={handleSignOut}>Logout</button>
      ) : (
